...
const CreateProduct = () => {
  ...
  return (
    <Layout title={"Admin-Dashboard Create-Product Ecom-App"}>
        ...
        <div className='row'>
            ...
            <div className='col-md-9'>
                ...
                <div className='m-1 w-75'>
                  ...
                  <div className='mb-3'>
                    <label className='btn btn-success col-md-12'>
                ...
                <div className='mb-3'>
                  <Select variant={false} placeholder="Select Shipping" size="large" showSearch className='form-select mb-3'
                  onChange={(value)=>{
                    setShipping(value)
                  }}>
