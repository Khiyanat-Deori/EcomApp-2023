...
const CreateCategory = () => {
  ...
  return (
    <Layout title={"Admin-Dashboard Create-Category Ecom-App"}>
        ...
        <div className='row'>
            ...
            <div className='col-md-9'>
                ...
                <table className="table">
                  ...
                  <tbody>
                      ...
                      <><tr>
                        ...
                        <button className='btn btn-primary' onClick={()=>handleDelete(c._id)}>Delete</button></td>
                      </tr></>
                      ))}
              ...
              <Modal onCancel={()=>setVisible(false)} footer={null} open={visible}><CategoryForm value={updatedName} 
